...
function gacha(){
	...
	if (prize<=9 || prize>=16) {
		...
		if (prize2==8) {
			...
			if (prize2a==6){
				document.getElementById("img1").src = "../img/Koraidon.png";
				document.getElementById("c-rar").innerHTML = "LGN";
				document.getElementById("namePk").innerHTML = "Koraidon";
			} else {
				document.getElementById("img1").src = "../img/Miraidon.png";
				document.getElementById("c-rar").innerHTML = "LGN";
			...
			if (prize2b==6){
				document.getElementById("img1").src = "../img/Sprigatito.png";
				document.getElementById("c-rar").innerHTML = "UNQ";
				document.getElementById("namePk").innerHTML = "Sprigatito";
			} else if (prize2b==7){
				document.getElementById("img1").src = "../img/Fuecoco.png";
				document.getElementById("c-rar").innerHTML = "UNQ";
				document.getElementById("namePk").innerHTML = "Fuecoco";
			} else {
				document.getElementById("img1").src = "../img/Quaxly.png";
				document.getElementById("c-rar").innerHTML = "UNQ";
		...
		if (prize3==6){
			document.getElementById("img1").src = "../img/Cetitan.png";
			document.getElementById("c-rar").innerHTML = "UCM";
			document.getElementById("namePk").innerHTML = "Cetitan";
		} else if (prize3==7){
			document.getElementById("img1").src = "../img/Cyclizar.png";
			document.getElementById("c-rar").innerHTML = "UCM";
			document.getElementById("namePk").innerHTML = "Cyclizar";
		} else if (prize3==8){
			document.getElementById("img1").src = "../img/Klawf.png";
			document.getElementById("c-rar").innerHTML = "UCM";
			document.getElementById("namePk").innerHTML = "Klawf";
		} else if (prize3==9){
			document.getElementById("img1").src = "../img/Armarouge.png";
			document.getElementById("c-rar").innerHTML = "UCM";
			document.getElementById("namePk").innerHTML = "Armarouge";
		} else {
			document.getElementById("img1").src = "../img/Ceruledge.png";
			document.getElementById("c-rar").innerHTML = "UCM";
...
function reset(){
	document.getElementById("img1").src = "../img/Siluet.png";
